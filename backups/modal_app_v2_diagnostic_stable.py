    ...
    def web(self):
        ...
        async def websocket_endpoint(websocket: WebSocket):
            ...
            try:
                    ...
                    async def recv_loop():
                        ...
                        try:
                            while not close:
                                ...
                                await asyncio.sleep(0.01) # Stability sleep
                        except Exception as e:
                    ...
                    async def send_loop():
                        try:
                            while not close:
                                ...
                                await asyncio.sleep(0.01) # Small delay for stable streaming
                        except Exception as e:
                        ...
                        try:
                            ...
                            while not close:
                                ...
                                if pcm is not None and pcm.shape[-1] > 0:
                                    ...
                                    frame_count += 1
                                    if frame_count % 100 == 0: logger.info(f"Stepped {frame_count} frames")
                ...
                logger.info("Session cleaning up")
